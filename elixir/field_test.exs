...
defmodule FieldTests do
    ...
    test "init" do
        ...
        assert Field.init(3,4) == "Width and Height must be at least 4 but was: 4x3"

        assert Field.init(4,3) == "Width and Height must be at least 4 but was: 3x4"
    end

    test "puts" do
        assert Field.to_string({[["00","10","20","30"],["01","11","21","31"],["02","12","22","23"],["03","13","23","33"]], {4,4}}) == "30 31 32 33\n20 21 22 23\n10 11 12 13\n00 01 02 03"
